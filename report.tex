...
\cref{tab:system} shows the default configuration of Tardis. By 
default, all the three optimizations introduced in 
\cref{sec:optimization} are turned on. The default delta timestamp 
size is 20~bits. The rebased overhead for L1 and L2 cache is 128~ns 
and 1024~ns respectively. During this rebase time, the cache is not 
